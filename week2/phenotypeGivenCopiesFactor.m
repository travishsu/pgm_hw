...
for i=1:length(phenotypeFactor.val)
        ...
        if assignment(1)==1
                phenotypeFactor.val(i) = alphaList(allelesToGenotypes(assignment(2),assignment(3)));
        else
                phenotypeFactor.val(i) =1 - alphaList(allelesToGenotypes(assignment(2),assignment(3)));
        end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
